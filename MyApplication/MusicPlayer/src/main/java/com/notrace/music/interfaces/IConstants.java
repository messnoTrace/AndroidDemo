...
public interface IConstants {
    public static final String BROADCAST_NAME="com.notrace.music.broadcast";
    public static final String SERVICE_NAME="com.notrace.music.services.MediaService";
    public static final String BROADCAST_QUERY_COMPLETE_NAME="com.notrace.music.querycomplete.broadcast";
    public  static final String BROADCAST_CHANGEBG="com.notrace.music.changebg";
    public static final String BROADCAST_SHAKE="com.notrace.music.shake";

    //是否开启震动模式
    public static final String SHAKE_ON_OFF="SHAKE_ON_OFF";

    public static final String SP_NAME="com.notrace.music_preference";
