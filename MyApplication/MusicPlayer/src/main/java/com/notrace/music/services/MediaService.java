package com.notrace.music.services;
...
import com.notrace.music.MainContentActivity;
import com.notrace.music.R;
import com.notrace.music.detector.ShakeDetector;
...
/**
 * Created by notrace on 2016/1/22.
 * 后台Service 控制歌曲的播放控制顶部notification的显示
 */
public class MediaService extends Service implements IConstants,ShakeDetector.OnShakeListener{


    private static final String PAUSE_BROADCAST_NAME="com.notrace.music.pause.broadcast";
    private static final String NEXT_BROADCAST_NAME="com.notrace.music.next.broadcast";
    private static final String PRE_BROADCAST_NAME="com.notrace.music.pre.broadcast";
